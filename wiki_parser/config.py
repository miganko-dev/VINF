...
class WikiConfig:
    ...
    skip_prefixes: List[str] = field(default_factory=lambda: [
        'Wikipedia:', 'Talk:', 'User:', 'Template:', 'Category:', 'File:',
        'Draft:', 'Portal:', 'Help:', 'MediaWiki:', 'Module:', 'TimedText:',
        'Book:', 'Education Program:', 'Gadget:', 'Gadget definition:'
    ])
    pokemon_keywords: List[str] = field(default_factory=lambda: [
        'pokemon', 'pokémon', 'pikachu', 'charizard', 'nintendo', 'game freak', 'pokedex', 'pokédex'
    ])
...
class PokemonConfig:
    ...
    rarities: List[str] = field(default_factory=lambda: [
        'Common', 'Uncommon', 'Rare', 'Holo Rare', 'Reverse Holo', 'Ultra Rare', 'Secret Rare',
        'Full Art', 'Rainbow Rare', 'Gold Rare', 'Illustration Rare', 'Special Art Rare',
        'VMAX', 'VSTAR', 'EX', 'GX', 'V'
    ])
...
def ensure_directories() -> None:
    for directory in [WIKI_DIR, WIKI_SPARK_OUTPUT_DIR, WIKI_PARSED_DIR, JOINED_OUTPUT_DIR, STATISTICS_OUTPUT_DIR]:
